...
<body>
    <div class="col-lg-8 mx-auto p-4 py-md-5">
        ...
        <main>
            ...
            <?php if (key_exists('error', $tplCtx)) { ?>
            ...
            <p class="fs-5 col-md-12">
                ...
                <a href="<?php echo $tplCtx['issuer_url'] ?>/.well-known/openid-configuration">
                    <?php echo $tplCtx['issuer_url'] ?>/.well-known/openid-configuration
            ...
            <h2>Error</h2>
            <div class="mb-3">
                <code><?php echo $tplCtx['error'] ?></code>
            </div>
            ...
            <?php } else if (!key_exists('user', $tplCtx) || $tplCtx['user'] == NULL) { ?>
            ...
            <h1>You've logged in as <?php $tplCtx['user']->name ?></h1>
                ...
                <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>name</td>
                                            <td><?php echo $tplCtx['user']->name ?></td>
                                        </tr>
                                        <tr>
                                            <td>email</td>
                                            <td><?php echo $tplCtx['user']->email ?>
                                            <?php if ($tplCtx['user']->email_verified) { ?>
                                            (<i>verified</i>)
                                            <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>given_name</td>
                                            <td><?php echo $tplCtx['user']->given_name ?></td>
                                        </tr>
                                        <tr>
                                            <td>family_name</td>
                                            <td><?php echo $tplCtx['user']->family_name ?></td>
                                        </tr>
                                        <tr>
                                            <td>locale</td>
                                            <td><?php echo $tplCtx['user']->locale ?></td>
                                        </tr>
                                        <tr>
                                            <td>sub</td>
                                            <td><?php echo $tplCtx['user']->sub ?></td>
                                        </tr>
                                        <tr>
                                            <td>iss</td>
                                            <td><?php echo $tplCtx['user']->iss ?></td>
                                        </tr>
                                        <tr>
                                            <td>sub</td>
                                            <td><?php echo $tplCtx['user']->sub ?></td>
                                        ...
                                        <tr>
                                            <td>picture</td>
                                            <td><img src="<?php echo $tplCtx['user']->picture ?>" /></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <pre><code><?php echo $tplCtx['user_json'] ?></pre></code>
                            </div>
                        </div>
                    </div>
                </div>
